...
export const LAYER_CONFIG = {
  data: {
    ...
    subtitle: 'Búsqueda, Tendencia, Intención, Emoción',
  ...
  decision: {
    ...
    subtitle: 'Análisis y definición de estrategia',
  ...
  execution: {
    ...
    subtitle: 'Implementación en tiempo real',
  ...
  optimization: {
    ...
    subtitle: 'Evaluación y redistribución',
